...
set xlabel "Size"
set grid
set title "Error as a function of size (log scale) with precision=1024 bits"
set logscale y
set logscale x
set xtics (100,200,500,1000,2000,5000,10000)
set format y "10^{%L}"
# set pointsize 0.6
...
set key at graph 1.0, 0.65 # Left reverse
set output "../out/sz_log_1d.png"
